...
const Leaderboard = ({ users }) => {
    ...
    return (
        <div>
            <Nav />
            <div className=" max-w-xl mx-auto shadow-lg rounded-lg border px-4 py-4 flex flex-col">
                <h1 className="text-sky-800 text-3xl font-bold text-center mt-4 mb-4">Leaderboard</h1>
